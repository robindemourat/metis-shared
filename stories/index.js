...
const audioResource = {
  ...
  data: {
    ...
    transcription: `Voici quarante ans furent créés les départements d’arts plastiques dans les universités Françaises, ouvrant un espace pour une spécificité méthodologique, distincte des sciences de l’art, de l’histoire de l’art ou de l’esthétique, revendiquant une recherche par et pour la pratique.

De 1998 à 2010 en Europe, le processus de Bologne a uniformisé l’espace de l'enseignement supérieur notamment à travers la réforme Licence — Master — Doctorat, dite LMD.

Dans ce contexte, certaines écoles d’art ont mis en place des cycles de recherche en art et en design, alors non diplômant.`
  }
};
